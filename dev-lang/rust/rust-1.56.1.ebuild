...
SRC_URI="
	...
	!system-bootstrap? ( loong? ( https://github.com/phorcys/loongson-overlay/releases/download/rust-2022-1-6/rust-${PV}-loongarch64-unknown-linux-gnu.tar.xz ) !loong? ( $(rust_all_arch_uris rust-${RUST_STAGE0_VERSION}) ) )
"
...
PATCHES=(
	...
	"${FILESDIR}"/1.56-add-loongarch-support.patch
)
